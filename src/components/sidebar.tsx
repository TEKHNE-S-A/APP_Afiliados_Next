    ...
    <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 min-h-screen">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold text-gray-900">App Afiliados</span>
        </div>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-100">
        <div className="flex items-center gap-3 px-3 py-2 mb-2">
          ...
          <div className="min-w-0">
            <p className="text-xs font-medium text-gray-900 truncate">{session?.user?.name ?? 'Usuario'}</p>
