...
export async function GET(req: Request) {
  ...
  try {
    const result = await executeSIA('COSEGUROS_PENDIENTES_APP', { AfiliadoId: afiliadoId })
    ...
    console.error('[SIA coseguros-pendientes]', error)
    return fail(500, 'INTERNAL_ERROR', 'Error inesperado en coseguros pendientes')
  }
}
