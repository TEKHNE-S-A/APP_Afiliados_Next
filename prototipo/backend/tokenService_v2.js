...
function loadConfig() {
  try {
    ...
    console.error('tokenService_v2: error cargando config', err)
  }
  return {}
}
...
async function getTimeoutMinutes() {
  ...
  try {
    ...
    console.warn('tokenService_v2: error leyendo nusispar CREDENCIAL, fallback a config.json', err.message)
  }
