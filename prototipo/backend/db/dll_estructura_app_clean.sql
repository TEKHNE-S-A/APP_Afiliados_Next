...
-- DROP TYPE public.adadhesi;

DROP TYPE IF EXISTS public.adadhesi CASCADE;
CREATE TYPE public.adadhesi AS (
	adadhcodig int2,
	adadhdescr bpchar(40),
	adadhdetal bpchar(200),
	adadhfbaja date,
	adadhflimi date,
	adadhbaseu varchar(128),
	adadhhost varchar(128),
	adadhport int2,
	adadhsecur int2);

-- DROP TYPE public.adadhusu;

DROP TYPE IF EXISTS public.adadhusu CASCADE;
CREATE TYPE public.adadhusu AS (
	adadhcodig int2,
	nuusuid bpchar(40),
	adadusuval bool,
	adadhfalta date,
...
-- DROP TYPE public.ausoaufo;

DROP TYPE IF EXISTS public.ausoaufo CASCADE;
CREATE TYPE public.ausoaufo AS (
	ausolicid bpchar(36),
	ausolfotid bpchar(36),
	ausolf bytea,
	ausolf_gxi varchar(2048));

-- DROP TYPE public.ausolici;

DROP TYPE IF EXISTS public.ausolici CASCADE;
CREATE TYPE public.ausolici AS (
	ausolicid bpchar(36),
	nuusuid bpchar(40),
	ausoldescr bpchar(40),
	ausolfecal date,
	ausolfecor date,
	autippreid bpchar(30),
	ausolnroaf bpchar(20),
	ausoltexto text,
	ausolentid bpchar(30),
	ausolfecve date,
	ausolextid bpchar(30),
	ausolrechd bpchar(1),
	ausolestad bpchar(3),
	ausolentno bpchar(50),
	ausolautnu bpchar(40),
	ausoltipo bpchar(1),
	ausolpsoco bpchar(40),
	ausolcantp int2,
	ausolobspr bpchar(40),
	ausolgravc int2);

-- DROP TYPE public.autippre;

DROP TYPE IF EXISTS public.autippre CASCADE;
CREATE TYPE public.autippre AS (
	autippreid bpchar(30),
	autipprede bpchar(40),
	autipfecba date);

-- DROP TYPE public.bipagosg;

DROP TYPE IF EXISTS public.bipagosg CASCADE;
CREATE TYPE public.bipagosg AS (
	bipagoid bpchar(36),
	nuusuafili varchar(40),
	bipaggenaf varchar(40),
	bipaggenfe date,
	bipagoribi bpchar(36));

-- DROP TYPE public.bipagosp;

DROP TYPE IF EXISTS public.bipagosp CASCADE;
CREATE TYPE public.bipagosp AS (
	bipagoid bpchar(36),
	nuusuafili varchar(40),
	bipagodesc bpchar(40),
	bipagoesta bpchar(3),
	bipagofech date,
	bipagoimpo numeric(15,2),
	bipagobill bpchar(36),
	bipagoidex varchar(40),
	bipagotipo bpchar(3),
	bipagorefe bpchar(40),
	bipagoafil varchar(40),
	bipagonroa bpchar(20),
	bipagoapen bpchar(60));

-- DROP TYPE public.cacartil;

DROP TYPE IF EXISTS public.cacartil CASCADE;
CREATE TYPE public.cacartil AS (
	cacarid bpchar(36),
	nuplaid bpchar(30),
	carubid bpchar(30),
	caespid bpchar(30),
...
-- DROP TYPE public.caendire;

DROP TYPE IF EXISTS public.caendire CASCADE;
CREATE TYPE public.caendire AS (
	caentid bpchar(30),
	caendid bpchar(30),
	nulocid bpchar(30),
	caendirecc varchar(1024),
	caendirpri bpchar(1),
	caendgeolo bpchar(50),
	caendhorat varchar(100),
	caendpenge bpchar(1));

-- DROP TYPE public.caentele;

DROP TYPE IF EXISTS public.caentele CASCADE;
CREATE TYPE public.caentele AS (
	caentid bpchar(30),
	caendid bpchar(30),
	caenteleid bpchar(30),
	caentelefo bpchar(20),
	caentelepr bpchar(1));

-- DROP TYPE public.caentida;

DROP TYPE IF EXISTS public.caentida CASCADE;
CREATE TYPE public.caentida AS (
	caentid bpchar(30),
	caentapeno bpchar(50),
	caentmail varchar(100),
	caentweb varchar(1000),
	caentmarca bool,
	caentprior int2);

-- DROP TYPE public.caespeci;

DROP TYPE IF EXISTS public.caespeci CASCADE;
CREATE TYPE public.caespeci AS (
	caespid bpchar(30),
	carubid bpchar(30),
	caespdescr bpchar(40));

-- DROP TYPE public.camicart;

DROP TYPE IF EXISTS public.camicart CASCADE;
CREATE TYPE public.camicart AS (
	nuusuid bpchar(40),
	caentid bpchar(30),
	camictipoc bpchar(1));

-- DROP TYPE public.carubro;

DROP TYPE IF EXISTS public.carubro CASCADE;
CREATE TYPE public.carubro AS (
	carubid bpchar(30),
	carubdescr bpchar(40),
	carubtipor bpchar(3));

-- DROP TYPE public.crcreden;

DROP TYPE IF EXISTS public.crcreden CASCADE;
CREATE TYPE public.crcreden AS (
	crcreid bpchar(30),
	crcrefecvi date,
	crcrelin text,
	crcrenroaf bpchar(20),
	crcreapeno bpchar(62),
	crcreafili varchar(40),
	crcrecuil int8,
	crcreplaid bpchar(30),
	crcrei bytea,
	crcrei_gxi varchar(2048),
	crcredocum bpchar(20),
	crcresexo bpchar(1),
	crcrefecha date,
	crcrehash varchar(256),
	crcreifech timestamp);

-- DROP TYPE public.crcredus;

DROP TYPE IF EXISTS public.crcredus CASCADE;
CREATE TYPE public.crcredus AS (
	nuusuid bpchar(40),
	crcreid bpchar(30),
	crcrepropi bpchar(1));
...
-- DROP TYPE public.crdatos;

DROP TYPE IF EXISTS public.crdatos CASCADE;
CREATE TYPE public.crdatos AS (
	crdatid int4,
	crdatdescr bpchar(40),
	crdattipo bpchar(1),
	crdatetiqu bpchar(80),
	crdatnombr bpchar(40),
	crdatetixp int2,
	crdatetiyp int2,
	crdatetico bpchar(20),
	crdatetifu varchar(40),
	crdateties bpchar(10),
	crdatetita int2,
	crdatxpos int2,
	crdatypos int2,
	crdatcolor bpchar(20),
	crdatfuent varchar(40),
	crdatestil bpchar(10),
	crdattaman int2,
	crdatyorde int2,
	crdatxorde int2);

-- DROP TYPE public.evevalua;

DROP TYPE IF EXISTS public.evevalua CASCADE;
CREATE TYPE public.evevalua AS (
	evevalenti bpchar(30),
	evevaldire bpchar(30),
	nuusuid bpchar(40),
	evevafecha date,
	evevapunta int2,
	evevaobser text);

-- DROP TYPE public.gxdeviceresult;

DROP TYPE IF EXISTS public.gxdeviceresult CASCADE;
CREATE TYPE public.gxdeviceresult AS (
	gxapplicationid bpchar(127),
	gxqueryid bpchar(127),
	gxresultset bpchar(127),
	gxdeviceid bpchar(127),
	gxsyncdate date);

-- DROP TYPE public.gxparameters;

DROP TYPE IF EXISTS public.gxparameters CASCADE;
CREATE TYPE public.gxparameters AS (
	gxparid bpchar(20),
	gxparvalue bpchar(80));

-- DROP TYPE public.gxresultrows;

DROP TYPE IF EXISTS public.gxresultrows CASCADE;
CREATE TYPE public.gxresultrows AS (
	gxresultset bpchar(127),
	gxrowpk varchar(255),
	gxrowhash bpchar(127));

-- DROP TYPE public.hicuesti;

DROP TYPE IF EXISTS public.hicuesti CASCADE;
CREATE TYPE public.hicuesti AS (
	hicuestid bpchar(40),
	hicuestdes varchar(128),
	hicuestfde date,
	hicuestfha date,
	hicuesttip bpchar(3));

-- DROP TYPE public.hievalua;

DROP TYPE IF EXISTS public.hievalua CASCADE;
CREATE TYPE public.hievalua AS (
	nuusuid bpchar(40),
	hiidatenci bpchar(40),
	hicuestid bpchar(40),
	hievalotor int2,
	hievalfech date);

-- DROP TYPE public.hihistor;

DROP TYPE IF EXISTS public.hihistor CASCADE;
CREATE TYPE public.hihistor AS (
	nuusuid bpchar(40),
	hiidatenci bpchar(40),
	hidesconoc bpchar(1),
	hientinomb bpchar(40),
	hifecha date,
	hicantidad int2,
	hifechamod date,
	hientiid bpchar(40));

-- DROP TYPE public.noinfuti;

DROP TYPE IF EXISTS public.noinfuti CASCADE;
CREATE TYPE public.noinfuti AS (
	noinfutili bpchar(36),
	noinftipo bpchar(1),
	noinfdescr bpchar(40),
	noinftelef bpchar(20),
	noinfldire varchar(1024),
	noinfgeolo bpchar(50),
	noinim bytea,
	noinim_gxi varchar(2048),
	noinflink varchar(1000));

-- DROP TYPE public.nonoveda;

DROP TYPE IF EXISTS public.nonoveda CASCADE;
CREATE TYPE public.nonoveda AS (
	nonovid bpchar(36),
	nonovdescr varchar(200),
	nonovfecha date,
	nonovtexto text,
	nonovfecvi date,
	nonofo bytea,
	nonofo_gxi varchar(2048));

-- DROP TYPE public.nudispos;

DROP TYPE IF EXISTS public.nudispos CASCADE;
CREATE TYPE public.nudispos AS (
	nudistipod int2,
	nudisid bpchar(128),
	nudistoken varchar(1000),
	nudisdescr bpchar(128),
	nudisosnam varchar(40),
	nudisosver varchar(40),
	nudislangu varchar(40),
	nudisplatf varchar(128),
	nudisavcod varchar(40),
	nudisavnam varchar(40));

-- DROP TYPE public.nulocali;

DROP TYPE IF EXISTS public.nulocali CASCADE;
CREATE TYPE public.nulocali AS (
	nulocid bpchar(30),
	nulocdescr bpchar(40),
	nuproid bpchar(30));

-- DROP TYPE public.numedia;

DROP TYPE IF EXISTS public.numedia CASCADE;
CREATE TYPE public.numedia AS (
	numeid varchar(30),
	numeparam bpchar(30),
	numeimg bytea,
	numeimg_gx varchar(2048));

-- DROP TYPE public.numessa1;

DROP TYPE IF EXISTS public.numessa1 CASCADE;
CREATE TYPE public.numessa1 AS (
	nuusuid bpchar(40),
	numesid int8,
	numeeid int2,
	numeedescr varchar(512));

-- DROP TYPE public.numessag;

DROP TYPE IF EXISTS public.numessag CASCADE;
CREATE TYPE public.numessag AS (
	nuusuid bpchar(40),
	numesid int8,
	numesmensa text,
	numesfecen date,
	numesfecre date,
	numestitul varchar(80),
	nudistipod int2,
	nudisid bpchar(128),
	numesenvia bpchar(1),
	numesulter int2);

-- DROP TYPE public.numitem;

DROP TYPE IF EXISTS public.numitem CASCADE;
CREATE TYPE public.numitem AS (
	numitid varchar(256),
	numitdescr bpchar(40),
	numitorden int2,
	numitesfun bool,
	numithabil bool,
	numitdesam varchar(200));

-- DROP TYPE public.nupais;

DROP TYPE IF EXISTS public.nupais CASCADE;
CREATE TYPE public.nupais AS (
	nupaiid bpchar(30),
	nupaidescr bpchar(40));

-- DROP TYPE public.nupermis;

DROP TYPE IF EXISTS public.nupermis CASCADE;
CREATE TYPE public.nupermis AS (
	nuperrolei int8,
	numitid varchar(256));

-- DROP TYPE public.nuplan;

DROP TYPE IF EXISTS public.nuplan CASCADE;
CREATE TYPE public.nuplan AS (
	nuplaid bpchar(30),
	nupladescr bpchar(40),
	nuplim bytea,
	nuplim_gxi varchar(2048),
	nuplalad bpchar(1),
	nuplimfech timestamp);

-- DROP TYPE public.nuplcre;

DROP TYPE IF EXISTS public.nuplcre CASCADE;
CREATE TYPE public.nuplcre AS (
	nuplaid bpchar(30),
	crdatid int4,
	nuplcetiqu bpchar(80),
	nuplcetixp int2,
	nuplcetiyp int2,
	nuplcetico varchar(40),
	nuplcetifu varchar(40),
	nuplceties bpchar(10),
	nuplcetita int2,
	nuplcxpos int2,
	nuplcypos int2,
	nuplccolor varchar(40),
	nuplcfuent varchar(40),
	nuplcestil bpchar(10),
	nuplctaman int2,
	nuplcyorde int2,
	nuplcxorde int2);

-- DROP TYPE public.nuproces;

DROP TYPE IF EXISTS public.nuproces CASCADE;
CREATE TYPE public.nuproces AS (
	nuprcid bpchar(36),
	nuprcdescr varchar(128),
	nuprcinife timestamp,
	nuprcfinfe timestamp,
	nuprcarchi bytea,
	nuprcfilna varchar(512),
	nuprcfilty varchar(20),
	nuprctotre int4,
	nuprcuacfe timestamp,
	nuprcregpr int4,
	nuprcaltus varchar(100),
	nuprcaltfe timestamp,
	nuprccanus varchar(100),
	nuprccanfe timestamp,
	nuprcestad bpchar(3),
	nuprccancm varchar(512));

-- DROP TYPE public.nuprovin;

DROP TYPE IF EXISTS public.nuprovin CASCADE;
CREATE TYPE public.nuprovin AS (
	nuproid bpchar(30),
	nuprodescr bpchar(40),
	nupaiid bpchar(30));

-- DROP TYPE public.nusispar;

DROP TYPE IF EXISTS public.nusispar CASCADE;
CREATE TYPE public.nusispar AS (
	nusisgrupa bpchar(30),
	nusistippa bpchar(30),
	nusisvalpa text);

-- DROP TYPE public.nuusdisp;

DROP TYPE IF EXISTS public.nuusdisp CASCADE;
CREATE TYPE public.nuusdisp AS (
	nuusuid bpchar(40),
	nudistipod int2,
	nudisid bpchar(128),
	nuusdfecul date);

-- DROP TYPE public.nuusuari;

DROP TYPE IF EXISTS public.nuusuari CASCADE;
CREATE TYPE public.nuusuari AS (
	nuusuid bpchar(40),
	nuusuafili varchar(40),
	nuplaid bpchar(30),
	nuusufecha date,
	nuusunroaf bpchar(20),
	nuususexo bpchar(1),
	nuusuapell bpchar(60),
	nuusuestit bpchar(1),
	nuusutelef bpchar(20),
	nuusumail varchar(100),
	nuusubille bpchar(1),
	nuusuidbil bpchar(40),
	nuusumailf timestamp,
	nuusui_gxi varchar(2048),
	nuusui bytea,
	nuusuacept bpchar(1),
	nuusuqrbil text,
	nuusuultno int8,
	nuusubajaf timestamp,
	nuusunivel int2);

-- DROP TYPE public.nuusutok;

DROP TYPE IF EXISTS public.nuusutok CASCADE;
CREATE TYPE public.nuusutok AS (
	nuusutkid varchar(40),
	nuusutkafi varchar(40),
	nuusutkmai varchar(100),
	nuusutkvto date);
...
-- DROP TYPE public.toteleco;

DROP TYPE IF EXISTS public.toteleco CASCADE;
CREATE TYPE public.toteleco AS (
	totelconid int8,
	totelconnr varchar(20),
	totelconto bpchar(6),
	totelconfe timestamp);

-- DROP TYPE public.tuentida;

DROP TYPE IF EXISTS public.tuentida CASCADE;
CREATE TYPE public.tuentida AS (
	tuentid bpchar(30),
	tuentnombr bpchar(100),
	tuenturl varchar(1000),
	tuentactiv bool);
