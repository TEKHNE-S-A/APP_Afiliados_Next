// Fix funciones duplicadas en PostgreSQL
// 10/02/2026 - Eliminar duplicados y recrear correctamente
...
async function fixDuplicateFunctions() {
  ...
  try {
    const sqlPath = path.join(__dirname, 'db', 'fix_duplicate_functions.sql');
